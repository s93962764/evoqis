<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Housing_societyaspx.aspx.cs" Inherits="RCInfotech.Housing_societyaspx" %>
...
<body>
    ...
    <div class="container">
         ...
         <hr />
            ...
            <br />
         <div>
             <h3 style="margin-left:15px; background-color:red; width:730px; color:white"><b>Consultancy Service</b></h3>
         ...
         <div class="col-xs-12 col-sm-4 wow fadeInDown">
             <img src="images/concultancy.jpg" />
        </div>
...
<%--                <div class="col-md-3 col-sm-6">
               ...
               <%-- <div class="span4">
                            ...
                            <%--<iframe width="100%" height="310" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://goo.gl/maps/2Vr2xN4Bf7P2"></iframe>--%>
                                 <a class="navbar-brand" onclick="openNewWindows1()" ><img src="images/map1.png" alt="logo" style="cursor:pointer; height: 199px; width: 244px;"  /></a>
                            </div>
                              </div>
