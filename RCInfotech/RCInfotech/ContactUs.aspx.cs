    ...
    public partial class ContactUs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           /* var today = DateTime.Today;
            int sr_no = 1;
            string qry = "SELECT coalesce(max(sr_no),0),v_date FROM [v_contact] WHERE v_date='" + @today + "' group by v_date ";
            ...
            {
               // Label1.Text = dr[0].ToString() + dr[1].ToString();
