<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppDevelopment.aspx.cs" Inherits="RCInfotech.AppDevelopment" %>
    ...
    <header id="header">
      ...
      <div class="container">
         ...
         <hr />
            ...
            <br />
         <div>
             <h3 style="margin-left:15px; background-color:red; width:730px; color:white"><b>Project Management</b></h3>
         <div class="col-xs-12 col-sm-8 wow fadeInDown">
            <p style="text-align:justify">
              Project management is the discipline of initiating, planning, executing, controlling, and closing the work of a team to achieve specific goals and meet specific success criteria.The development of software for an improved business process, the construction of a building or bridge, the relief effort after a natural disaster, the expansion of sales into a new geographic market 
                <ul>
