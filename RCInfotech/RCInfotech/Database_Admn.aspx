<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_society.aspx.cs" Inherits="RCInfotech.Employee_society" %>
    ...
    <header id="header">
      ...
      <div class="container">
         ...
         <hr />
            ...
            <br />
         <div>
             <h3 style="margin-left:15px; background-color:red; width:730px; color:white"><b>Database Adiministration</b></h3>
         <div class="col-xs-12 col-sm-8 wow fadeInDown">
            <p style="text-align:justify">
             Database administration is the function of managing and maintaining database management systems (DBMS) software. Mainstream DBMS software such as Oracle, IBM DB2 and Microsoft SQL Server need ongoing management. As such, corporations that use DBMS software often hire specialized information technology personnel called Database Administrators or DBAs.
                <ul>
                    <li>Installation, configuration and upgrading of Database server software and related products.</li>
                    <li>Take care of the Database design and implementation.</li>
                    <li>Implement and maintain database security</li>
                    <li>Work as part of a team and provide 24x7 support when required.</li>
                    <li>Plan growth and changes</li>
                </ul>
            </p>
        </div>
