<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Co-operative_bank.aspx.cs" Inherits="RCInfotech.Co_operative_bank" %>
    ...
    <header id="header">
      ...
      <div class="container">
         ...
         <hr />
            ...
            <br />
         <div>
             <h3 style="margin-left:15px; background-color:red; width:730px; color:white"><b>Application Production Support</b></h3>
         <div class="col-xs-12 col-sm-8 wow fadeInDown">
            <p style="text-align:justify">
             Production support is the practices and disciplines of supporting the IT systems/applications which are currently being used by the end users. A production support person/team is responsible for receiving incidents and requests from end-users, analyzing these and either responding to the end user with a solution or escalating it to the other IT teams. These teams may include developers, system engineers and database administrators.
                <ul>
                    <li>Recording Production Error</li>
                    <li>Notification of Production Error</li>
                    <li>Investigation or Analysis of Production Error</li>
                    <li>Resolution of Production Error</li>
                    <li>Production Process correction</li>
                </ul>
            </p>
        </div>
         ...
         <div class="col-xs-12 col-sm-4 wow fadeInDown">
             <img src="images/Production-Support.jpg" />
        </div>
