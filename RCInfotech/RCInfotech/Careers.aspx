<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Careers.aspx.cs" Inherits="RCInfotech.Careers" %>
...
<body>
    ...
    <header id="header">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                       ...
                       <li class="dropdown">
                        ...
                        <li class="active"><a href="Careers.aspx">Careers</a></li> 
        ...
        <div class="container">
            <img src="images/career2.jpg" alt="find-job" style="padding:0px">
            <br />
            <br />
               If you are looking for a career opportunity to expand your skill set, build your technical competencies as well as experience unparalleled industry exposure; 
              
                then R C Infotech is the place for you. 
               
               If our current job openings do not match what you're looking for, then submit your CV and let us know your interests and ambitions.

               Send your CV on<h5 style="color: red"> careers@rcipune.in</h5> and covering letter directly to the region you want to work in, or by job type to our  HR and Head Office teams.

               We look forward to receiving your CV and wish you luck in your job search.
            <br />
            <br />
        </div>
    <br /><br />
