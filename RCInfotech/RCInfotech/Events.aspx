<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retail_bank.aspx.cs" Inherits="RCInfotech.Retail_bank" %>
...
<body>
    ...
    <div class="container">
        <h2 class="auto-style2">Life @RCInfotech</h2>
        <p>We believe that an engaged employee is a productive employee! And at Paragyte, we create a life full of fun opportunities for professional learning and personal growth. A flat hierarchy and a transparent, open door policy makes working at RCInfotech fun. Team RCInfotech enjoys a wholesome work experience with –</p>
        <br />
   	<div id="vlightbox1">
<a class="vlightbox1" href="images/activity.jpg" title="activity"><img src="images/Gallery/activity.jpg" alt="activity"/></a>
<a class="vlightbox1" href="images/event1.jpg" title="development"><img src="images/Gallery/event1.jpg" alt="development"/></a>
<a class="vlightbox1" href="images/event2.jpg" title="event"><img src="images/Gallery/event2.jpg" alt="event"/></a>
<a class="vlightbox1" href="images/event3.jpg" title="IMG_20170222_101534719_HDR"><img src="images/Gallery/event3.jpg" alt="IMG_20170222_101534719_HDR"/></a>
<a class="vlightbox1" href="images/event6.jpg" title="IMG_20170225_154807009_HDR"><img src="images/Gallery/event6.jpg" alt="IMG_20170225_154807009_HDR"/></a>
<a class="vlightbox1" href="images/event5.jpg" title="IMG_20170225_154815416"><img src="images/Gallery/event5.jpg" alt="IMG_20170225_154815416"/></a>
	</div>
    </div>
  ...
  <br />
    ...
    <script src="js/thumbscript1.js"></script>
    <script src="js/visuallightbox.js"></script>
    <script src="js/vlbdata1.js"></script>
</body>
</html>
